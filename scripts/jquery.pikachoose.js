    ...
    $pc.fn.extend({
        ...
        build: function() {
       	...
       	//create the structure for pikachoose
			this.wrap 		= $("<div class='pika-stage eleven columns alpha'></div>").insertBefore(this.list);
            ...
            this.captionII = $(this.caption).clone(true).insertAfter(this.list);
            this.captionII.addClass("five columns omega toUse");
         ...
         */
	     ...
	     finishAnimating: function(data){
			...
			if(data.clickThrough != ""){
     		...
     		if(this.options.showCaption && data.caption != "" && data.caption != null && this.captionII != null){
     			//this.caption.html(data.caption).fadeTo('slow',1);
                this.captionII.html(data.caption).fadeTo('slow',1);
